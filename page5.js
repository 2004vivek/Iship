...
let setinterval = setInterval(() => {
  ...
  let offset = 276.32 - (276.32 * seconds) / 60;
...
section1_left.addEventListener("mousemove", (e) => {
  ...
  if (offsetX > offsetY) {
    ...
    if (y < rect.height / 2) {
      section1_left.style.borderTop = "4px solid white";
    } else {
      section1_left.style.borderBottom = "4px solid red";
    }
  }
});
...
btn2.addEventListener("click", () => {
  ...
  btn2.disabled="true"
  // window.location.href = "" // Link has to be Inserted...
});
function Submit() {
